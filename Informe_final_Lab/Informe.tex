...
\section*{Montaje}
    ...
    Se conectan ambas bobinas en paralelo a una fuente de alimentación DC mediante cables de conexión. Se ajusta el sensor de campo
    magnético para medir el campo en el centro de la bobina de Helmholtz. Se conecta un multimetro para medir el voltaje aplicado a las
    bobinas. Mediante el uso del gaussómetro se mide el campo magnético generado en el centro de la bobina para diferentes valores de 
    voltaje aplicados. 

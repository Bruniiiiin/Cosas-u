...
\hline
\textbf{V [V]} & \textbf{I Total [A]} & \textbf{I Bobina [A]} & \textbf{B [mT]} \\
\hline
...
\section*{Análisis}
    ...
    Ademas al comparar el valor obtenido con el valor teórico de la permeabilidad magnética del aire, que es $\mu_0 = 4\pi \times 10^{-7} \text{H/m}$,
    ...
    El error porcentual entre el valor teórico y el valor experimental se calcula de la siguiente manera:

    \begin{align}
    \% \text{Error} &= \left| \frac{\mu_{0} - \mu_{exp}}{\mu_{exp}} \right| \times 100 \\
